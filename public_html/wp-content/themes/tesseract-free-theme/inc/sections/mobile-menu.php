 ...
 */
   	...
   	$wp_customize->add_section( 'tesseract_mobmenu' , array(
		...
		$wp_customize->add_setting( 'tesseract_mobmenu_header_background_color', array(
			...
			$wp_customize->add_control(
				...
				'tesseract_mobmenu_header_background_color_control',

				array(

					'label'      => __( 'Mobile Header Background Color', 'tesseract' ),

					'section'    => 'tesseract_mobmenu',

					'settings'   => 'tesseract_mobmenu_header_background_color',
		...
		$wp_customize->add_setting( 'tesseract_mobmenu_background_color', array(
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'      => __( 'Menu Background Color Button', 'tesseract' ),
